                ...
                <div class="relative" style="width: calc(100vw - 2.5rem)">
                    ...
                    <div class="absolute flex justify-start items-center w-full h-full">
                        <a id="nav-bar-main" href="index.html#splash-screen" class="flex flex-row justify-start items-center">
                            <img src="../docs/icons/png/bird256.png" class="w-12 h-nav"/>
                    ...
                    <div class="absolute flex justify-end items-center w-full h-full">
                        <a href="../docs/error.html" class="absolute">
                        ...
                        <div class="scale-0 md:scale-100 flex flex-row justify-center">
                            <a href="https://www.instagram.com/teammetalpipe/"><img class="w-8 h-8" src="../docs/icons/png/instagram.png" alt="Our Instagram Account"></a>
                            <div class="w-2"></div>
                            <a href="https://www.tiktok.com/t/ZT884QV5g/"><img class="w-8 h-8" src="../docs/icons/png/tiktok.png" alt="Our Tik-Tok Account"></a>
                        </div>
                    </div>
                </div>
            </div>
